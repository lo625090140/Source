...
public class UpdateService extends Service {
     ...
     * 服务器固定地址
     */
    private static final String APK_URL_TITLE = "http://www.imooc.com/mobile/mukewang.apk";//下载的地址
    /**
     * 文件存放路经
     */
    ...
    public void onCreate() {
        ...
        filePath = Environment.getExternalStorageDirectory() + "/imooc/imooc.apk";//保存的路径
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        switch (apkUrl = APK_URL_TITLE) {
        }
